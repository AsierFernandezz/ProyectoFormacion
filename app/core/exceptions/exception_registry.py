...
from app.core.exceptions.exception_handler import (
    ...
    user_not_authenticated_handler, user_not_admin_handler, token_expired_handler
)
...
class ExceptionRegistry:
    ...
    def _security_handlers(self):
        self.app.add_exception_handler(TokenExpired, token_expired_handler)
        self.app.add_exception_handler(UserNotAuthenticated, user_not_authenticated_handler)
        self.app.add_exception_handler(UserNotAdmin, user_not_admin_handler)
